...
| [**Seaus**](https://github.com/Seaus-Tech/Seaus) | `SwiftUI` `macOS` `iOS` | The core foundational framework and shared utility suite powering the Seaus product ecosystem. |
